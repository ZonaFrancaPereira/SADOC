  ...
  <form action="procesar_formulario.php" method="post">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label for="id_detalle_equipo">ID Detalle Equipo</label>
          <input type="text" class="form-control" id="id_detalle_equipo" name="id_detalle_equipo" placeholder="ID Detalle Equipo">
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label for="id_activo_fk">ID Activo FK</label>
          <input type="text" class="form-control" id="id_activo_fk" name="id_activo_fk" placeholder="ID Activo FK">
        </div>
