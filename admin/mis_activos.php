                                                ...
                                                ?>
                                                            <div class="card">
                                                                ...
                                                                <div id="collapse<?php echo $counter; ?>" class="collapse" aria-labelledby="heading<?php echo $counter; ?>" data-parent="#accordion">
                                                                    <div class="card-body">
                                                                        <!-- Aquí colocas los detalles del activo -->
                                                                        <p class=""><b>Activo: </b> <?php echo $nombre_activo ?> </p>
                                                                        <p class="text-muted text-sm"><b>Descripción Activo: </b> <?php echo $descripcion_articulo ?> </p>
                                                        ...
                                                        <div class="card-header text-center border-bottom-0">
                                                            <p>Cada uno de estos Activos se encuentran asignados al siguiente colaborador</p>
